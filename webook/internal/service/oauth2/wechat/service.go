...
func (s *WechatService) AuthURL(ctx context.Context) (string, error) {
...
func (s *WechatService) VerifyCode(ctx context.Context, code string, state string) (domain.WechatInfo, error) {
